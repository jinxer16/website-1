  ...
  return (
    <StyledStepCard width="100%">
      <StepCardInner height={['200px', '180px', null, '200px']}>
        ...
        <Text color="#fff">{step.subtitle}</Text>
      </StepCardInner>
    </StyledStepCard>
  )
}
  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 5 USD in BPT per ticket.'),
    },
    {
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="#fff">
                {t('100% of the BPT paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="#fff">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed BPT for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </li>
          </BulletList>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="#fff">
                {t(
                  '10,000 BPT from the treasury is added to a lottery round every other day. This BPT is of course also included in rollovers! Read more in our guide to ',
                )}
                <InlineLink href="https://bash-protocol.gitbook.io/bash-protocol-docs/">
                  {t('BPT Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      {/* <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://bash-protocol.gitbook.io/bash-protocol-docs/use-case/bash-lottery">
              {t('how to play the Bash Protocol lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex> */}
