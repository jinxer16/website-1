  ...
  const farmsList = useCallback(
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        console.log('debug apr', farm.pid, farm.lpSymbol, farm.token.busdPrice)
        const { cakeRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET], new BigNumber(farm.bashPerBlock))
    ...
    <>
      <PageHeader>
        <Heading as="h1" scale="xxl" color="orange" mb="24px">
          {tokenMode ? <img src="/images/new/logo.png" alt="Pools" style={{"paddingRight":"10px", "height":"40px"}}/> : <img src="/images/new/farm.png" alt="Farms" style={{"paddingRight":"10px", "height":"50px"}}/>}
