const config = [
  {
    ...
    description: [
      'In the Basic Sale, every user can commit a maximum of about 100 USD worth of BPT-ADA LP Tokens. We calculate the maximum LP amount about 30 minutes before each LAUNCHPAD. The Basic Sale has no participation fee.',
      'In the Unlimited Sale, there’s no limit to the amount of BPT-ADA LP Tokens you can commit. However, there’s a fee for participation: see below.',
    ],
  },
  {
  ...
  },
  {
    ...
    description: [
      'We burn it. The BPT-ADA LP tokens from the participation fee will be decomposed. We will then use the ADA portion to market buy the BPT equivalent, and finally throw all of the BPT into the weekly token burn.',
    ],
  },
  {
    title: 'How can I get an achievement for participating in the LAUNCHPAD?',
    description: [
      'You need to contribute a minimum of about 10 USD worth of BPT-ADA LP Tokens to either sale.',
