...
import { Currency, currencyEquals, Percent, WETH } from '@pancakeswap/sdk'
            ...
            {!showDetailed && (
              <BorderCard>
                ...
                <Flex flexWrap="wrap" justifyContent="space-evenly">
                  <Button color="#FFF" scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '25')}>
                    25%
                  </Button>
                  <Button color="#FFF" scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '50')}>
                    50%
                  </Button>
                  <Button color="#FFF" scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '75')}>
                    75%
                  </Button>
                  <Button color="#FFF" scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '100')}>
                    Max
                  </Button>
                </Flex>
              </BorderCard>
                  ...
                  {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                    <RowBetween style={{ justifyContent: 'flex-end', fontSize: '14px' }}>
                      {oneCurrencyIsETH ? (
                        ...
                        <StyledInternalLink
                          to={`/remove/${currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'ADA' : currencyIdA}/${
                            currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'ADA' : currencyIdB
                          }`}
                        >
                          {t('Receive ADA')}
                        </StyledInternalLink>
